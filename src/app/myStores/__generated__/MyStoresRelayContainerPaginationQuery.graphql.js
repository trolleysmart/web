/**
 * @flow
 * @relayHash fdfe5c038069d3dada462b78930ae960
 */
...
export type MyStoresRelayContainerPaginationQueryResponse = {|
  +user: ?{| |};
|};
*/

/*
query MyStoresRelayContainerPaginationQuery(
  $count: Int!
  $cursor: String
) {
  user {
...
const batch /*: ConcreteBatch*/ = {
  fragment: {
    ...
    kind: 'Fragment',
    metadata: null,
    name: 'MyStoresRelayContainerPaginationQuery',
    selections: [
      {
        kind: 'LinkedField',
        alias: null,
